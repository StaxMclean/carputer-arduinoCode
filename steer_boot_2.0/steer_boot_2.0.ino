...
const int analogInPin = A10;  // Analog input pin that the stepped resistor steering circuit is attached to
const int referenceInPin = A9;  // Analog input pin that the stepped resistor acc circuit is attached to
